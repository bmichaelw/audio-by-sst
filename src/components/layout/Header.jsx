...
import { Menu, X, User, LogOut, Home, Library, Shield, DollarSign, TrendingUp, Radio, Settings, Sparkles } from 'lucide-react';
...
export default function Header({ user, currentPageName, isMenuOpen, setIsMenuOpen, onLogin, onLogout }) {
  const navItems = [
    ...
    { name: 'Discover', icon: Sparkles, href: createPageUrl('Discover') },
